...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="container  mx-auto p-6">
      <div className=" mx-auto  flex flex-col gap-10 mt-[10%] justify-between  bg-white rounded-lg overflow-hidden md:max-w-lg">
        <h2 className="text-3xl text-center font-semibold text-gray-700 z-50">
          Contact Us
        </h2>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-4 z-50">
          <CustomInput
            type="email"
            {...register("email")}
            className=""
